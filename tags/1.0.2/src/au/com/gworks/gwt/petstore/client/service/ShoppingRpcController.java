...
public interface ShoppingRpcController extends RemoteService {
	...
	public static class Util {
		private static ShoppingRpcControllerAsync instance;

		public static ShoppingRpcControllerAsync getInstance() {
			if (instance == null) {
				instance = (ShoppingRpcControllerAsync) GWT.create(ShoppingRpcController.class);
				ServiceDefTarget target = (ServiceDefTarget) instance;
				String ep = EndpointUtils.getInstance().adapt("/shoppingRpcController.rpc");
